var Scedaddle = (function () {
  ...
  var insertCssExports = {};
  var insertCss$1 = {
    get exports(){ return insertCssExports; },
    set exports(v){ insertCssExports = v; },
  };
  ...
  var insertCss_2 = insertCssExports.insertCss = insertCss;
   ...
   * @returns {boolean}
   */
  function isElementSupported(tagName) {
      if (!tagName) {
          return false;
      }
   ...
   */
  function wrapElement(node, wrapper, returnWrapper) {
      if (node.parentNode) {
   ...
   */
  function on(node, events, selector, fn) {
      var handler = fn;
   ...
   * @param {function} fn
   */
  function addListeners(node, events, fn) {
  ...
  var defaultCommands = {
      ...
      color: {
          ...
          _customColors: (rebuild, instance) => {
              ...
              let colorPickerContainer = createElement("div", {
              ...
              let addButton = createElement("span", {
              ...
              let customColorsContainer = createElement("div", {
  ...
  var textareaCaretExports = {};
  var textareaCaret = {
    get exports(){ return textareaCaretExports; },
    set exports(v){ textareaCaretExports = v; },
  };
  ...
  var getCaretCoordinates = textareaCaretExports;
  ...
  function Editor(origine, customOptions = {}) {
      ...
      base.createMenu = (menuName, obj) => {
          ...
          each(contents, (i, content) => {
              ...
              appendChild(
                  tabContent,
                  isString(content) ? parseHTML(content) : content
              );
              /* */
              appendChild(contentWrapper, tabContent);
          });

          appendChild(container, contentWrapper);
          appendChild(tabs, container);
